...
CREATE TABLE `API_products` (
  ...
  CONSTRAINT `fk_API_products_products` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE CASCADE
...
CREATE TABLE `buys` (
  ...
  `buying_date` bigint DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `buys` VALUES (1,4,5,1,2,2,NULL,1627225288379),(2,4,5,1,2,2,NULL,1627225364460),(3,3,5,1,1,1,1,1627225364460),(4,4,5,1,2,2,NULL,1627225376611);
...
CREATE TABLE `category_product` (
  ...
  CONSTRAINT `fk_category_product_products` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE CASCADE
...
CREATE TABLE `characterises` (
  ...
  CONSTRAINT `fk_characterises_products` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE CASCADE,
...
CREATE TABLE `mades_of` (
  ...
  CONSTRAINT `fk_mades_of_materials` FOREIGN KEY (`materials_id`) REFERENCES `materials` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_mades_of_products` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE CASCADE
...
INSERT INTO `materials` VALUES (1,'Lin',5.40,1000,NULL,'1626769886499-lin.jpg'),(2,'Coton',1.23,2000,NULL,'1626769904796-coton.jpg'),(3,'Flanelle',8.40,500,NULL,'1626769917466-flanelle.jpg'),(4,'Soie',10.80,200,NULL,'1626769934716-soie.jpg');
...
INSERT INTO `products_images` VALUES (1,'https://www.dolcegabbana.com/dw/image/v2/AAGA_PRD/on/demandware.static/-/Sites-15/default/dwfe7b1b65/images/zoom/I3C02WHPAAQ_HR2ZI_0.jpg?sw=742&sh=944&sm=fit','Un pantalon pas beaux a fleur'),(2,'https://img01.ztat.net/article/spp-media-p1/9753872023d63b2b8bc9c9f7b89e7246/e79ee0b39bc34506922100f52cd1b13e.jpg?imwidth=762&filter=packshot','Une chemise incroyable'),(3,'https://witt.eu/product/resized/040/040.00ZUK92341-A01.069_7_bg.jpg','Une Robe tendance'),(4,'https://www.univers-decor.com/8087-thickbox_default/lot-de-2-rideaux-occultant-taupe-clair-140-x-260-cm.jpg','Des dideaux detailler'),(5,'http://www.lesdoucesnuitsdemae.com/media/catalog/product/cache/1/image/500x500/9df78eab33525d08d6e5fb8d27136e95/h/o/housse-couette-belle-nuit-1643470.jpg','Des drap funky'),(6,'https://live.staticflickr.com/4036/4682415035_c113db13c3_4k.jpg','Robe1(Hood?)'),(7,'https://live.staticflickr.com/1302/4682415031_344e0c8bf7_4k.jpg','Robe2(soirée?)'),(8,'https://live.staticflickr.com/4047/4682415045_0df9ac183a_4k.jpg','Robe3(étoiles?)'),(9,'1626771616816-Robe_Cote.jpg','Robe_Cote.jpg'),(10,'1626771616849-Robe_Cote2.jpg','Robe_Cote2.jpg'),(11,'1626771616866-Robe_Devant.jpg','Robe_Devant.jpg'),(12,'1626774329487-Robe_Cote.jpg','Robe_Cote.jpg'),(13,'1626774329501-Robe_Cote2.jpg','Robe_Cote2.jpg'),(14,'1626774329508-Robe_Devant.jpg','Robe_Devant.jpg'),(15,'1626780397599-brucebanner.jpeg','jpeg'),(16,'1626780397601-brucebanner.jpg','jpg'),(17,'1626780445769-assiette.jpg','assiette'),(18,'1626780457201-assiette.jpg','assiette'),(19,'1626780516302-assiette.jpg','assiette'),(20,'1626785906362-assiette.jpg','assiette'),(21,'1626787016263-assiette.jpg','assiette.jpg'),(22,'1626787080569-assiette.jpg','assiette.jpg'),(23,'1626787295792-assiette.jpg','assiette'),(24,'1626787307276-coton.jpg','coton'),(25,'1626787512339-brucebanner.jpeg','brucebanner'),(26,'1626787602206-brucebanner.jpeg','brucebanner'),(27,'1626787737527-brucebanner.jpeg','brucebanner'),(28,'1626787794357-brucebanner.jpeg','brucebanner'),(29,'1626787974298-obiwan.jpg','obiwan'),(30,'1626787985075-assiette.jpg','assiette'),(31,'1626787985076-obiwan.jpg','obiwan'),(32,'1626788229534-denim.jpg','denim'),(33,'1626788282310-denim.jpg','denim'),(34,'1626788531013-flanelle.jpg','flanelle'),(35,'1626789015100-flanelle.jpg','flanelle'),(36,'1626789072907-flanelle.jpg','flanelle'),(37,'1626789096250-flanelle.jpg','flanelle'),(38,'1626789327859-flanelle.jpg','flanelle'),(39,'1626789385513-flanelle.jpg','flanelle'),(40,'1626789482729-flanelle.jpg','flanelle'),(41,'1626789531752-flanelle.jpg','flanelle'),(42,'1626789564979-flanelle.jpg','flanelle'),(43,'1626789621062-flanelle.jpg','flanelle'),(44,'1626789655971-captain-1280x720.jpg','captain-1280x720'),(45,'1626789655974-Class_fonction.png','Class_fonction'),(46,'1626789731375-captain-1280x720.jpg','captain-1280x720'),(47,'1626789731378-Class_fonction.png','Class_fonction'),(48,'1626789794467-captain-1280x720.jpg','captain-1280x720'),(49,'1626789794473-Class_fonction.png','Class_fonction'),(50,'1626789838476-captain-1280x720.jpg','captain-1280x720'),(51,'1626789838481-Class_fonction.png','Class_fonction');
...
CREATE TABLE `represents` (
  ...
  CONSTRAINT `fk_represents_products` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE CASCADE,
...
INSERT INTO `represents` VALUES (1,3,1),(2,4,2),(4,6,4),(5,7,5),(6,5,6),(7,5,7),(8,5,8),(15,NULL,15),(16,NULL,16);
...
-- Dump completed on 2021-07-26  9:25:42
